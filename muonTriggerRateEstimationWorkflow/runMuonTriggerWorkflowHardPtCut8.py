...
saveFolder = "_muonTriggerRateHardPtCut5_Set3"
binning = "[5, 9, 10, 11, 12, 13, 15, 17, 20, 25, 30, 35, 40, 45, 50, 60, 70, 100, 140, 200]"
...
#minimumPtToReachMuonChamber = barrelMuonChamberRadius * magneticField/6.6
minimumPtToReachMuonChamber = 5
#
####################################################################################################
...
#sample_BinnedDistributions = "l1tMuonGenMuonMatching_SingleMu_FlatPt_8to100_QualityCut_WQualityBranch"
...
#options.extraOptions.append("minimumPtInBarrel=" + str(minimumPtToReachMuonChamber))
#options.extraOptions.append("barrelEta=" + str(barrelEta))
##options.nevents=100
#loop = main(options, folderAndScriptName, parser)
#os.system("mv " + saveFolder + "/" + sample_BinnedDistributions + " " + saveFolder + "/highPt_ConvolutionCurves")
#
#
#print "MOVING RESULTS"
#
#os.system("mv " + saveFolder + "/highPt_ConvolutionCurves/histograms.root " + saveFolder + "/binnedDistributions.root")
#
...
#                                                           barrelEta = barrelEta,
#                                                           minPtInBarrel = minimumPtToReachMuonChamber,
#                                                         )
#
#
...
#  if efficiencyFactors[x] > 1:
#    efficiencyFactors[x] = 1
#  
...
sample_ClosureTest1 = "l1tMuonGenMuonMatching_SingleMu_FlatPt_8to100_QualityCut_WQualityBranch"
#convolutionFileName = "" + saveFolder + "/binnedDistributions.root"
...
##options.nevents=100
#loop = main(options, folderAndScriptName, parser)
#os.system("mv " + saveFolder + "/" + sample_ClosureTest1 + " " + saveFolder + "/" + sample_ClosureTest1 + "_ClosureTestPlots_QualityCutOnGenMuon")
#
...
#(options,args) = parser.parse_args()
#folderAndScriptName = [saveFolder, "muonTriggerRateEstimationWorkflow/plotTransverseMomentumDistributionForMuonClosureTest_FromMatchedPairs_cfg.py"]
sample_ClosureTest2 = "l1tMuonGenMuonMatching_SingleMu_FlatPt_8to100_QualityCut_WQualityBranch_GenMuons"
#convolutionFileName = "" + saveFolder + "/binnedDistributions.root"
...
##options.nevents=100
#loop = main(options, folderAndScriptName, parser)
#os.system("mv " + saveFolder + "/" + sample_ClosureTest2 + " " + saveFolder + "/" + sample_ClosureTest2 + "_ClosureTestPlots_AllGenMuons")
#
...
#cfg.plots = [
##  #Files here
#  ["" + saveFolder + "/" + sample_ClosureTest1 + "_ClosureTestPlots_QualityCutOnGenMuon/histograms.root", "coarseBinnedPtl1tMuonDistribution", "CMS L1TMuon"],
#  ["" + saveFolder + "/" + sample_ClosureTest1 + "_ClosureTestPlots_QualityCutOnGenMuon/histograms.root", "coarseBinnedSmearedPtgenParticleDistribution", "Sim L1TMuon from matched gen #mu"]
...
##  #Files here
#  ["" + saveFolder + "/" + sample_ClosureTest1 + "_ClosureTestPlots_QualityCutOnGenMuon/histograms.root", "coarseBinnedPtl1tMuonDistribution", "CMS L1TMuon"],
#  ["" + saveFolder + "/" + sample_ClosureTest2 + "_ClosureTestPlots_AllGenMuons/histograms.root", "coarseBinnedSmearedPtgenParticleDistribution", "Sim L1TMuon from every gen #mu"]
##  ["_closureTest/l1tMuonGenMuonMatching_QCD_15_3000_NoPU_Phase1_WQualityBranch_L1TMuon_vs_SimL1TMuon_PtDistribution/histograms.root", "coarseBinnedPtSimL1TMuonDistribution", "SimL1TMuon"],
##  ["_closureTest/l1tMuonGenMuonMatching_QCD_15_3000_NoPU_Phase1_WQualityBranch_L1TMuon_vs_SimL1TMuon_PtDistribution/histograms.root", "coarseBinnedPtL1TMuonDistribution", "Original L1TMuon"],
#]
