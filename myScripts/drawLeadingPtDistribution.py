...
delphesSim_ff_H_WW_enuenu_1000events.electronLeadingRecoPtDistribution.GetXaxis().SetRangeUser(0, 200)
...
delphesSim_ff_W_enu_1000events.electronLeadingRecoPtDistribution.GetXaxis().SetRangeUser(0, 200)
...
delphesSim_ff_H_ZZ_eeee_1000events.electronLeadingRecoPtDistribution.GetXaxis().SetRangeUser(0, 200)
...
delphesSim_ff_Z_ee_1000events.electronLeadingRecoPtDistribution.GetXaxis().SetRangeUser(0, 200)
