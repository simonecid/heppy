...
#Object name
triggerObjectName = "#mu^{L1T}"
sampleName = "cmsMatching_QCD_15_3000_L1TMuon_GenJet"
...
l1tMuonPtDistributionBinnedInGenJet = cfg.Analyzer(
  MatchedObjectBinnedDistributions,
  instance_label = 'l1tMuonPtDistributionBinnedInGenJet',
  histo_name = 'l1tMuonPtDistributionBinnedInGenJet',
...
l1tMuonEtaDistributionBinnedInGenJet = cfg.Analyzer(
  MatchedObjectBinnedDistributions,
  instance_label = 'l1tMuonEtaDistributionBinnedInGenJet',
  histo_name = 'l1tMuonEtaDistributionBinnedInGenJet',
...
l1tMuonGenJetPtRatioDistributionBinnedInGenJet = cfg.Analyzer(
  MatchedObjectBinnedDistributions,
  instance_label = 'l1tMuonGenJetPtRatioDistributionBinnedInGenJet',
  histo_name = 'l1tMuonGenJetPtRatioDistributionBinnedInGenJet',
...
sequence = cfg.Sequence( [
  source,
  tightRestrictionMatchSelector,
  l1tMuonPtDistributionBinnedInGenJet,
  l1tMuonGenJetPtRatioDistributionBinnedInGenJet,
  l1tMuonEtaDistributionBinnedInGenJet,
