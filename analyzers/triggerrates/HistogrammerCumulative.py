...
class HistogrammerCumulative(Analyzer):
  '''Generic histogrammer that takes a particle type and plots the sum of a certain quantity in that type
  ...
  def beginLoop(self, setup):
    super(HistogrammerCumulative, self).beginLoop(setup)
